...
public:
	...
	static pointer create(flash_communcation_ptr pCommunication, boost::asio::io_service& rIOService);
	void start();
	boost::asio::ip::tcp::socket& socket();
	void write(std::string);
	void stop();
	ofxFlashConnection(flash_communcation_ptr pComm, boost::asio::io_service& rIOService);
private:
